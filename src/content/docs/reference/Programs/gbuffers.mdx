...
The following programs are added by Iris. These programs pull geometry from their fallback, and provide more specificity to the geometry rendered. They also serve to separate translucent geometry that would otherwise render in the same program as opaque geometry, which should be used with [`ENTITY_TRANSLUCENT`](/reference/shadersproperties/flags).

| gbuffers program               | geometry                                                                                                                     | fallback program      |
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------|-----------------------|
| gbuffers_particles             | particles                                                                                                                    | gbuffers_textured_lit |
| gbuffers_particles_translucent | particles that support translucency (requires [`particles.ordering=mixed`](/reference/shadersproperties/ordering#particlesordering)) | gbuffers_particles    |
