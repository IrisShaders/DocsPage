...
In Iris 1.7 and newer, the last component stores the light level of the current block (without the influence of nearby light sources). This can be used to tell if a block is emissive.
