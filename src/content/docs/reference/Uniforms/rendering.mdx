...
```
The alpha blending function multipliers for the current program, as described in [`blend.<program>`](/reference/shadersproperties/rendering#blend). The components of the vector store the following:
