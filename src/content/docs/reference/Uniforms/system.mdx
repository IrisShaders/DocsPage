...
```
This value stores the aspect ratio of the game window in a format of [`viewWidth`](/reference/uniforms/system#viewwidth)`/`[`viewHeight`](/reference/uniforms/system#viewheight). More information about aspect ratios and there uses can be found on [wikipedia](https://en.wikipedia.org/wiki/Aspect_ratio_(image)).
