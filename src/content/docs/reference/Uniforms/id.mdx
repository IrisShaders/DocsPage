...
**Note:** if [`oldHandLight`](/reference/shadersproperties/options#oldhandlight) is not set to `false`, `heldBlockLightValue` will take its value from the hand with the highest light value for legacy support.
