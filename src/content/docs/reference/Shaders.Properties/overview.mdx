...
| Directive                                                       | Description | Tag |
| --------------------------------------------------------------- | ----------- | --- |
| [custom uniforms](/reference/shadersproperties/custom_uniforms) | Iris lets you define custom uniforms which are evaluated on the CPU and uploaded on program change |  |
