...
```properties
value.TAA = Temporal Anti-aliasing
value.SSBO = Ambient Occlusion
```
...
```properties
value.TAA.comment = Smooths jagged edges
value.SSBO.comment = Adds shadows in the corners of objects
```
