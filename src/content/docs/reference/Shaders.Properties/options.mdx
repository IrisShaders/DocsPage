...
sky=<true|false>
```
Enables or disables rendering of the vanilla sky in gbuffers_skybasic. This includes the sky disc, horizon, and void, however it does not include [`stars`](/reference/shadersproperties/options#stars)
