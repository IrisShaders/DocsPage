...
To do these space conversions, we will make use of a function, `projectAndDivide`. This function applies a projection matrix and then divides by the `w` component, skipping straight to clip space. **Place this function definition outside and before `main` but after the declaration of `texcoord`.**
...
![](/src/assets/first_shader_guide/4/transparentshadows.png)
...
![](/src/assets/first_shader_guide/4/penumbra.png)
...
![](/src/assets/first_shader_guide/4/jaggedshadows.png)
...
![](/src/assets/first_shader_guide/4/softshadows.png)
...
![](/src/assets/first_shader_guide/4/lownoise.png)
...
![](/src/assets/first_shader_guide/4/highnoise.png)
...
![](/src/assets/first_shader_guide/4/softershadows.png)
