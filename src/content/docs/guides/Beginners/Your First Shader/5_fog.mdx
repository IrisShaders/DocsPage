...
Of course, we also need to have a fog colour to blend with, and for this, we'll use another uniform, a `vec3` [`fogColor`](/reference/uniforms/general/fogcolor).
...
![](/src/assets/first_shader_guide/5/linearfog.png)
...
![](/src/assets/first_shader_guide/5/foggraph.png)
...
![](/src/assets/first_shader_guide/5/exponentialfog.png)
