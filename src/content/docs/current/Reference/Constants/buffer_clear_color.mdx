...
The ClearColor directive is used when clearing is enabled, and it defines the value stored in a [colortex](/current/reference/buffers/colortex) or [shadowcolor](/current/reference/buffers/shadowcolor) buffer after the clear operation (see [buffer clear](/current/reference/constants/buffer_clear)).
