...
:::caution[Warning]
In some packs, you may find the atlas referenced with `tex` or `texture`. This is undefined behavior, and assumes that any undefined samplers will point to the atlas. It is strongly recommended you do not do this.
:::
