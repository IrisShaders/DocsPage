---
title: Custom Images
description: Allows the shader to write up to 8 custom full images of data. 
sidebar:
  label: Custom Images
  order: 3
  badge:
