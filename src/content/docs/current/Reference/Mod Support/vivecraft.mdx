...
[Vivecraft](https://modrinth.com/mod/vivecraft) is a mod which allows Minecraft to be played in VR. Vivecraft provides a few macros and uniforms to inform shaders about the current render state.  
