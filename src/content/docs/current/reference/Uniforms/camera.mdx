...
```
This uniform stores the value of [`eyeBrightness`](/reference/uniforms/camera#eyebrightness), smoothed over time. The speed of the smoothing can be controlled with [`eyeBrightnessHalflife`](/reference/constants/eyebrightnesshalflife).
