...
| [sky](/reference/shadersproperties/features#sky)                                         | Enables or disables rendering of vanilla sky in `gbuffers_skybasic`                                                     | <Badge text="Iris Exclusive" variant="tip"/> |
| [stars](/reference/shadersproperties/features#stars)                                     | Enables or disables rendering of stars in the sky in `gbuffers_skybasic`                                                | <Badge text="Iris Exclusive" variant="tip"/> |
